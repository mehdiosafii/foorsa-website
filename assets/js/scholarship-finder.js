(function() {
  ...
  var i18n = {
    en: {
      ...
      step2Title: 'Your Academic Profile',
      ...
      privacyNote: 'Your information is secure and will only be used to find matching scholarships.',
    ...
    fr: {
      ...
      step2Title: 'Votre Profil Académique',
      ...
      privacyNote: 'Vos informations sont sécurisées et ne seront utilisées que pour trouver des bourses correspondantes.',
    ...
    ar: {
      ...
      privacyNote: 'معلوماتك آمنة ولن تُستخدم إلا للعثور على المنح المناسبة.',
